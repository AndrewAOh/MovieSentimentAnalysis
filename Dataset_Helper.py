...
def create_sentiment_ranking_dataset(MOVIE_SENTIMENT_RANKING_DS, IMDB_MOVIE_RANKS_DS):
    ...
    # Change Column Names
    renamed_columns = {
        'Movie_Title': 'Title', 'average_sentiment_score': 'Sentiment Model Score', 
    ...
    Sentiment_Ranking_Dataset["Sentiment Model Rank"] = Sentiment_Ranking_Dataset.index + 1

    # Adjust scoring of sentiment model (x100)
    Sentiment_Ranking_Dataset['Sentiment Model Score'] = Sentiment_Ranking_Dataset['Sentiment Model Score'] * 100
